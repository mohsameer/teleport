...
type ProxyServiceClient interface {
	...
	DialNode(context.Context) *connect.BidiStreamForClient[v0.Frame, v0.Frame]
}
...
func NewProxyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProxyServiceClient {
	...
	return &proxyServiceClient{
		dialNode: connect.NewClient[v0.Frame, v0.Frame](
			httpClient,
...
type proxyServiceClient struct {
	dialNode *connect.Client[v0.Frame, v0.Frame]
}

// DialNode calls proto.ProxyService.DialNode.
func (c *proxyServiceClient) DialNode(ctx context.Context) *connect.BidiStreamForClient[v0.Frame, v0.Frame] {
...
type ProxyServiceHandler interface {
	// DialNode opens a bidrectional stream to the requested node.
	DialNode(context.Context, *connect.BidiStream[v0.Frame, v0.Frame]) error
}
...
func (UnimplementedProxyServiceHandler) DialNode(context.Context, *connect.BidiStream[v0.Frame, v0.Frame]) error {
