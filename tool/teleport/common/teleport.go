...
func Run(options Options) (app *kingpin.Application, executedCommand string, conf *servicecfg.Config) {
	...
	integrationConfDeployServiceCmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfDeployServiceIAMArguments.AccountID)
	...
	integrationConfEICECmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfEICEIAMArguments.AccountID)
	...
	integrationConfEC2SSMCmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfEC2SSMIAMArguments.AccountID)
	...
	integrationConfAWSAppAccessCmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfAWSAppAccessIAMArguments.AccountID)
	...
	integrationConfEKSCmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfEKSIAMArguments.AccountID)
	...
	integrationConfTAGSyncCmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfAccessGraphAWSSyncArguments.AccountID)
	...
	integrationConfListDatabasesCmd.Flag("aws-account-id", "The AWS account ID.").Required().StringVar(&ccf.IntegrationConfListDatabasesIAMArguments.AccountID)
